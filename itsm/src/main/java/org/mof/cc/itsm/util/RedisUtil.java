...
public class RedisUtil {
	 ...
	 *
	 * @param key
	 * @param value //TimeUnit.SECONDS 秒 //TimeUnit.MINUTES 分
	 * @return
	 */
	...
	/**
	 * 执行list操作 在列表中的尾部添加一个个值，返回列表的长度
	 *
	 * @param key
	 * @return
	 */
